...
from gdc_rnaseq_tools.merge_counts import (
    merge_star_counts,
    load_star_file,
    main)
...
class TestMergeStarGeneCounts(unittest.TestCase):
    star_counts_1 = os.path.join(os.path.dirname(__file__),
                                 'etc/test_star_counts_input_1.tsv.gz')
    star_counts_2 = os.path.join(os.path.dirname(__file__),
                                 'etc/test_star_counts_input_2.tsv.gz')
    exp_star_1 = os.path.join(os.path.dirname(__file__),
                              'etc/exp_star_counts_output_1.tsv.gz')
    exp_star_1_2 = os.path.join(os.path.dirname(__file__),
                                'etc/exp_star_counts_output_1_2.tsv.gz')
    out_test_pfx = os.path.join(os.path.dirname(__file__),
                                'etc/test_star_merge_gene_counts_out')
    to_remove = []
